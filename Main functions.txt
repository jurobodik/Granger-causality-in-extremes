...
# 'q_z'                   The coefficient tau_z = q_z * n, describing the conditioning on Z_t. This is irrelevant if Z is NULL. For strong confounding effects, set q_z to 0.2 or 0.3.
